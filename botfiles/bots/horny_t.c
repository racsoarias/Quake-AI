...
//
// Name:			horny_c.c
// Function:		chat lines for Horny
// Programmer:		Oscar Arias
// Scripter:		Oscar Arias
// Last update:		5/30/19
...
chat "horny"
{
	...
	type "game_enter"
	{
		...
		"~TEN-SHUN! ~Horney is in the House.";  
	...
	type "level_end_lose"
	{
		...
		"Looks like ol' ~Horney's tactics could use some re-evaluation.";
	} //end type
